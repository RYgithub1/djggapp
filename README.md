...
* Escape sequence:\n\t. ''*10. set(). List Comprehensions and lambda. *args**kwargs. @decorator. Property, Lambda, Generator. if __name (vs import calc). try-except. Scraping, time.sleep. col-number. Recursive, Inner-function.
